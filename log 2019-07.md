...
**Pensées** : J'ai rencontré un problème de "visualisation". Pour m'en sortir, j'ai d'abord travaillé les données affichées (initialement) puis les fonction de changement (onChange...)

Je dois prévoir le temps à rédiger mon journal - j'ai constaté beaucoup de trous.

**Liens vers les travaux** : [Faire remonter l'état 2](https://codepen.io/jmarcm/pen/qeOQLN?editors=0011)
